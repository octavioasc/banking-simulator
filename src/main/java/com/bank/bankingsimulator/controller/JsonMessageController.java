...
import com.bank.bankingsimulator.kafka.JsonKafkaProducer;
import com.bank.bankingsimulator.model.Event;
import com.bank.bankingsimulator.payload.User;
...
public class JsonMessageController {
    ...
    public ResponseEntity<String> publish(@RequestBody Event event){
        ...
        return ResponseEntity.ok("Message send to a kafka topic");
    }
